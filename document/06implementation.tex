...
% TODO dopisat ako v paperi, ze sme nezmensili nijak vyrazne komplexitu kostry
\vspace{5mm}
\noindent 
...
\begin{center}
  ...
  \caption[The Four-Channel Pose Estimation pipeline.]{ The Four-Channel Pose Estimation pipeline: First, point clouds are segmented into body regions in the segmentation network (top), then the input point clouds are concatenated with the predicted per-point body region assignment as a fourth channel, and fed into the regression network (bottom).}
